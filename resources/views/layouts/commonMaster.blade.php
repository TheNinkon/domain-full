...
<head>
  ...
  <meta name="description"
    content="{{ trim($__env->yieldContent('meta-description', config('variables.templateDescription') ?: '')) }}" />
  <meta name="keywords"
  ...
  <!-- Private admin pages stay noindex; public marketplace pages override this to "index, follow" -->
